...
public class JadePlugin implements IWailaPlugin {
    ...
    public void registerClient(IWailaClientRegistration registration) {
        ...
        registration.registerEntityComponent(NextEatProvider.Client.INSTANCE, DuckEntity.class);
        registration.registerEntityComponent(NextEatProvider.Client.INSTANCE, GooseEntity.class);
    }
