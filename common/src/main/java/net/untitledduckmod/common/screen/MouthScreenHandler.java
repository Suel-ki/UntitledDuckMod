...
public class MouthScreenHandler extends ScreenHandler implements ExtendedFactory<MouthScreenHandler, MouthData> {
    private final Inventory entityInventory;
    private final int entityId;
    private WaterfowlEntity entity;

    public MouthScreenHandler(int syncId, PlayerInventory inventory, MouthData data) {
        this(syncId, inventory, new SimpleInventory(1), data.holderType(), data.entityId());
    }
    ...
    @Override
    public MouthScreenHandler create(int syncId, PlayerInventory inventory, MouthData data) {
        return new MouthScreenHandler(syncId, inventory, data);
    }
}
