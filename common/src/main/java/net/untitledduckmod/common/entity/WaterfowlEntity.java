...
public abstract class WaterfowlEntity extends TameableEntity implements GeoAnimatable, MouthHoldable{
    ...
    public void writeCustomDataToNbt(NbtCompound tag) {
        ...
        tag.put(MOUTH_ITEM_TAG, this.mouthInventory.getStack(0).encodeAllowEmpty(this.getRegistryManager()));
    }
    ...
    public void readCustomDataFromNbt(NbtCompound tag) {
        ...
        this.setBabyScale(tag.getFloat(BABY_SCALE_TAG));
        ...
        if (tag.contains(MOUTH_ITEM_TAG, NbtCompound.COMPOUND_TYPE)) {
            ItemStack stack = ItemStack.fromNbtOrEmpty(this.getRegistryManager(), tag.getCompound(MOUTH_ITEM_TAG));
